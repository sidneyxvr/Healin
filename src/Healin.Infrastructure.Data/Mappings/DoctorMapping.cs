...
namespace Healin.Infrastructure.Data.Mappings
{
    public class DoctorMapping : IEntityTypeConfiguration<Doctor>
    {
        public void Configure(EntityTypeBuilder<Doctor> builder)
        {
            ...
            builder.Property(user => user.Crm).HasColumnType("varchar(10)");
            ...
            {
                email.Property(e => e.Value).HasColumnType("varchar(256)").HasColumnName("Email");
            });
